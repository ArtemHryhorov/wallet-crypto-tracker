...
fun TransactionsByDate.toUiModel(): TransactionsByDateUiModel =
...
fun List<Transaction>.toTransactionsUiModelList(): List<TransactionUiModel> =
  map { it.toUiModel() }
